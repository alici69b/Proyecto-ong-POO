...
<head>
    ...
    <title>Cuenta eliminada - RESET ONG</title>
...
<body class="min-h-screen flex items-center justify-center text-[#004e64]">

    <div class="bg-white rounded-3xl border border-slate-100 shadow-xl p-12 max-w-md w-full mx-4 text-center">
        ...
        <div class="flex items-center justify-center gap-2 mb-6">
            ...
            <span class="font-black text-xl tracking-tighter text-[#004e64]">RESET</span>
        </div>

        <h1 class="text-2xl font-extrabold mb-3">Cuenta eliminada</h1>
        <p class="text-slate-500 text-sm mb-8">
            Tu cuenta ha sido eliminada correctamente. Gracias por haber formado parte de RESET ONG.
        </p>

        <a href="<?= BASE_URL ?>/index.php"
            class="block w-full bg-gradient-to-r from-[#00a5cf] to-[#9fffcb] text-[#004e64] font-extrabold text-sm py-3 rounded-2xl hover:opacity-90 transition-all">
            Volver al inicio
        </a>
    </div>
</body>
