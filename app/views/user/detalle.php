                            ...
                            <div class="flex-1 rounded-2xl px-4 py-3 relative
                                ...
                                <div class="flex items-center justify-between mb-1">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <!-- Botón tres puntos: solo en mensajes del USUARIO (no voluntario) y no eliminados -->
                                        <?php if (!$es_voluntario && empty($c['eliminado'])): ?>
                                            <div class="relative">
                                                ...
                                                <div id="menu-<?= $c['id'] ?>" class="hidden absolute right-0 top-6 bg-white rounded-xl shadow-lg border border-slate-100 py-1 z-10 min-w-[140px]">
                                                    <form method="POST" action="<?= BASE_URL ?>/app/controllers/controller_user_reset_detalle.php?id=<?= $reset['id'] ?>">
                                                        <input type="hidden" name="csrf_token" value="<?= generarTokenCSRF() ?>">
                                ...
                                <!-- Contenido o placeholder si está eliminado -->
